...
class Invader2 implements Simulable {
     ...
     */
    public Invader2(GUISimulator gui, Color invaderColor) {
        this.gui = gui;
    ...
    private void draw() {
        ...
        gui.addGraphicalElement(new Rectangle(x + 20, y, invaderColor, invaderColor, 10));

        gui.addGraphicalElement(new Text(x + 50, y + 120, invaderColor, "INVADER"));
    }
}
